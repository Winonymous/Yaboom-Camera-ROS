...
def generate_launch_description():
    ...
    resources_package = 'yahboom_camera_controller'
    ...
    rviz = IncludeLaunchDescription(
        ...
        # launch_arguments={"joint_state_publisher": 'false'}.items(),
        condition=IfCondition(use_rviz),
    )

    # bridge_params = os.path.join(get_package_share_directory(resources_package),'config','gz_bridge.yaml')
    # ros_gz_bridge = Node(
